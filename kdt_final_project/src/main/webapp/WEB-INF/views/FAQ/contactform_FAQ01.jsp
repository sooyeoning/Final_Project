		...
		<div class="section-container">
			...
			<div class="right-section">
				...
				<div id="content-2" class="expanded-content">
					...
					<p>
						1. 위치정보 이용에 동의하시려면?<br>
						<br> 위트 가입 시 동의 하시거나, 위트의 위치기반 서비스를 시작할 때 위치정보 수집 및 이용동의 약관이
						보여집니다. 검색결과 중 '지도' 기능을 사용하시거나, 검색결과 중 현재위치 중심의 결과를 보고자 하실 때 (예.
						우리동네 날씨) 위치정보이용동의를 하실 수 있습니다.<br>
						<br> 2. 위치정보 이용 동의를 해제하시려면?<br>
						<br> 1) '더보기[...]' 탭에서 우측상단 설정[톱니바퀴 모양의 아이콘 이미지]을 눌러 들어갑니다.

						2) '개인/보안 >개인정보 관리' 내에서 위치정보 이용 동의를 해제하시면 됩니다. 위치정보 이용 동의를 해제하시면
						위트는 수집된 위치정보 관련 기록을 파기합니다.
					</p>
				</div>
				...
				<div id="content-3" class="expanded-content">
					<p>
						최근 검색 목록에 노출된 정보는 [X] 버튼을 눌러 삭제할 수 있습니다.<br>
						<br> 만약 더 이상 검색한 키워드를 최근 검색 영역에 남기고 싶지 않다면, 최근검색어 목록 우측 상단의
						"자동저장끄기" 버튼을 누르면 최근검색어를 저장하지 않게 됩니다. <br>
						<br> 최근검색어를 저장하고 싶다면 "자동저장켜기" 버튼을 누르면 다시 최근 검색 목록을 보실 수 있습니다.
					</p>
				</div>
				...
				<div id="content-4" class="expanded-content">
					<p>
						...
						<br> 여행지 추천 탭의 경우 위트에서 제공하는 콘텐츠를 소비하기 편리하도록 검색 결과를 구성하였습니다. <br>
						<br> 커뮤니티탭에서는 페이지 상단의 지역 탭에서 효과적으로 지역별 커뮤니티 검색 결과를 확인하실 수
						있습니다.<br>
						<br>
					</p>
				</div>
				...
				<div id="content-5" class="expanded-content">
					<p>
						안드로이드 태블릿 위트의 언어 설정은, 사용자가 OS에서 설정한 언어 설정을 따라 노출됩니다.<br>
						<br> 휴대폰과 안드로이드 태블릿의 언어가 다르게 설정되어 있는 경우 각각 다르게 표시되는 것이 정상입니다.
					</p>
				</div>
